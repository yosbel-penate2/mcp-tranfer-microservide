            ...
            with sr.Microphone() as source:
                ...
                while True:
                    if bargein_audio is not None:
                        ...
                        bargein_audio = None
                        # If the user interrupted with exit keywords ("stop"),
                        # they were just trying to shut the assistant up.
                        # Ignore it and listen for the real command.
                        if text and any(
                            w in text for w in ["quit", "exit", "bye", "goodbye", "stop"]
                        ):
                            print("[DEBUG] Barge-in exit keyword ignored, re-listening")
                            text = None
                    else:
